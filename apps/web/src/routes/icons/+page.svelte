<script lang="ts">
	import IconExplorer from '$lib/components/icon-explorer.svelte';
	import {
		getCanonicalUrl,
		joinKeywords,
		SITE_NAME,
	...
	const title = 'Browse Pixel Icons | pxicons';
	const description =
		'Search pixelart Lucide icons in pxicons with the original fast browser, scrollable icon grid, and drawer-based usage details.';
	const keywords = [
